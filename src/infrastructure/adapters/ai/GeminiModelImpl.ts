...
import type {
  ...
  AIModelResponse,
} from '@/domain/interfaces/services/IAIModelService';
 ...
 */
export class GeminiModelImpl {
  private isInit = false;
  private readonly apiKey: string;
  private readonly modelName: string;
  private readonly modelLogger;
   ...
   * @example
   * const model = GeminiModelImpl.create({ apiKey: 'your-api-key' });
   * await model.initialize();
   */
  public static create(config: { apiKey: string; modelName?: string }): GeminiModelImpl {
    ...
    return new GeminiModelImpl(config.apiKey, config.modelName as string);
  }
   ...
   */
  public async initialize(config?: { apiKey?: string; modelName?: string }): Promise<void> {
